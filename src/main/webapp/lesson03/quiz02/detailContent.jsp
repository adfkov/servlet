...
%>
				...
				<div class="descriptiondes col-9">
					<div class="musicname display-4"><%=item.get("title") %></div>
					<div class="singer text-success font-weight-bold"><%=item.get("singer") %></div>
					<div class="moredescription d-flex text-secondary">
						<div class="mr-4">
							<div>앨범</div>
							<div>재생시간</div>
							<div>작곡가</div>
