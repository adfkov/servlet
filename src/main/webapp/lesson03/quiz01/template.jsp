...
<body>
	...
	<div id="wrap" class="container bg-secondary ">
		...
		<nav class="bg-info d-flex align-items-center">
			<ul class="nav nav-fill w-100 text-white"> <!--  ul 태그를 수직 기준 가운데 정렬 -->
				<li class="nav-item"><a href="/lesson03/quiz01/template.jsp?category=전체" class="nav-link text-white">전체</a></li>
